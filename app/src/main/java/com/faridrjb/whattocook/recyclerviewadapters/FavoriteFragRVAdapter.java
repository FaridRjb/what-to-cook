...
public class FavoriteFragRVAdapter extends RecyclerView.Adapter<FavoriteFragRVAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Food> foods = new ArrayList<>();

    public FavoriteFragRVAdapter(Context context, ArrayList<Food> foods) {
